    ...
    connection.connect(async function (err) {
        if (err) {
            ...
            try {
                ...
                const id2 =  await runQuery("IINSERT INTO events (title,  description, location) VALUES ('Company Picnic Db', 'Come for free food and drinks.', 'At the lake')  RETURNING id;", connection);
                console.log("Event added");
                await runQuery("INSERT INTO comments (comment, event_id) VALUES ('This is a db comment on the pet show',?)", connection, id1);
                console.log("Comment added");
                await runQuery("INSERT INTO comments (comment, event_id) VALUES ('This is a another db comment on the pet show',?)", connection, id1);
                console.log("Comment added");
                await runQuery("INSERT INTO comments (comment, event_id) VALUES ('This is a db comment on the picnic',?)", connection, id2);
                console.log("Comment added");
                await runQuery("INSERT INTO comments (comment, event_id) VALUES ('This is a another db comment on the picnic',?)", connection, id2);
                console.log("Comment added");
                succeeded = true;
                connection.destroy();
            }
